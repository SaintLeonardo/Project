...
public class FrmFuncionarios extends javax.swing.JFrame {
    ...
    //Executa metodo listar, listando os funcionarios
    //Cria JDefaultTableModel, passa os valores da lista, do lista func e bota na tabela
    public void listar() {
        FuncionariosDAO dao = new FuncionariosDAO(); //Ececuta o listarFuncionarios
        List<Funcionarios> lista = dao.listarFuncionarios(); //ListarFuncionarios retorna uma lista de funcionarios
        ...
        //Pega resultado lista, percorre e coloca nos dados = TableModel.
        for (Funcionarios c : lista) { //Para cada item da lista, cria objeto C
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        FuncionariosDAO dao = new FuncionariosDAO();  //Cria objeto para cadastrar no BD
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        // Carrega a lista:
        listar(); //Chama método que carrega lista
    }//GEN-LAST:event_formWindowActivated

    private void TabelaFuncionariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaFuncionariosMouseClicked
        // Informa as colunas para pegar os dados
        jTabbedPane1.setSelectedIndex(0); //Manda ir para a aba 0 ao apertar em cima dos registrados cadastrados

        txtCódigo.setText(TabelaFuncionarios.getValueAt(TabelaFuncionarios.getSelectedRow(), 0).toString()); //Ao clickar em cima da linha joga o valor do ID pra tela de cadastro
        ...
        txtEndereço.setText(TabelaFuncionarios.getValueAt(TabelaFuncionarios.getSelectedRow(), 11).toString());
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        FuncionariosDAO dao = new FuncionariosDAO();  //Cria objeto para alterar no BD
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        ...
        FuncionariosDAO dao = new FuncionariosDAO();  //Cria objeto para excluir no BD
